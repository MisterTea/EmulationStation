...
template <typename V>
void saveMap(pugi::xml_document &doc, std::map<std::string, V> &map, const char *type) {
...
void Settings::saveFile() {
	...
	saveMap<bool>(doc, mBoolMap, "bool");
	saveMap<int>(doc, mIntMap, "int");
	saveMap<float>(doc, mFloatMap, "float");
	saveMap<std::time_t>(doc, mTimeMap, "time");
